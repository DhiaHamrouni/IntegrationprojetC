...
{
GtkWidget
*w,*windowSmart_ESPRIT;
w=lookup_widget(button,"Dashboard_esprit");
gtk_widget_destroy(w);
windowSmart_ESPRIT=create_Smart_ESPRIT();
gtk_widget_show(windowSmart_ESPRIT);
}
...
w=lookup_widget(button,"Smart_ESPRIT");
gtk_widget_destroy(w);
...
w=lookup_widget(button,"chercher_dhia");
gtk_widget_destroy(w);
windowcapteur=create_capteur();
gtk_widget_show(windowcapteur);
treeview3=lookup_widget(windowcapteur,"treeview3");
...
on_refresh_alarmes_clicked             (GtkButton       *button,
                                        gpointer         user_data)
{
GtkWidget *windowAlarmes_dhia,*w1;
GtkWidget *treeview4;
w1=lookup_widget(button,"windowAlarmes_dhia");
...
fenetre_principale=lookup_widget(objet,"fenetre_authentiication");
fenetre_principale=create_fenetre_authentification();
...
GtkWidget *fenetre_principale;
GtkWidget *fenetre_trouve;
fenetre_principale=lookup_widget(objet_graphique,"fenetre_affiche_menu");

gtk_widget_destroy(fenetre_principale);
fenetre_trouve=lookup_widget(objet_graphique,"Smart_ESPRIT");
fenetre_trouve=create_Smart_ESPRIT();
...
{
output=lookup_widget(objet_graphique,"label183");
...
fenetre_principale=lookup_widget(button,"Bienvenue");
gtk_widget_destroy(fenetre_principale);
...
fenetre_principale=lookup_widget(button,"Smart_ESPRIT");

gtk_widget_destroy(fenetre_principale);
fenetre_trouve=lookup_widget(button,"fenetre_authentification");
fenetre_trouve=create_fenetre_authentification();
...
fenetre_trouve=create_authnouha();
gtk_widget_show(fenetre_trouve);
}
...
on_Ghassen_clicked                     (GtkButton       *button,
                                        gpointer         user_data)
{
GtkWidget *windowa,*windowb;

windowa=lookup_widget(button,"Smart_ESPRIT");
gtk_widget_destroy(windowa);

windowb=create_window_login_gas();
gtk_widget_show(windowb);
}
...
on_rima_clicked                        (GtkButton       *button,
                                        gpointer         user_data)
{
GtkWidget *windowa,*window_affiche;

windowa=lookup_widget(button,"Smart_ESPRIT");
gtk_widget_destroy(windowa);

window_affiche=create_authentification ();
...
fenetre_principale=lookup_widget(button,"Dashboard_esprit");

gtk_widget_destroy(fenetre_principale);
fenetre_trouve=lookup_widget(button,"fenetre_nombre");
fenetre_trouve=create_fenetre_nombre();
...
{
GtkWidget *fenetre_principale;
GtkWidget *fenetre_trouve1,*fenetre_trouve2;


fenetre_principale=lookup_widget(button,"Dashboard_esprit");

gtk_widget_destroy(fenetre_principale);
fenetre_trouve1=lookup_widget(button,"meilleur_menu");
fenetre_trouve1=create_meilleur_menu ();
fenetre_trouve2=lookup_widget(button,"meilleur_plat");
fenetre_trouve2=create_meilleur_plat ();

gtk_widget_show(fenetre_trouve1);
gtk_widget_show(fenetre_trouve2);
}
...
fenetre_trouve=create_affichage0();
gtk_widget_show(fenetre_trouve);
GtkWidget *treeview1;
		treeview1=lookup_widget(fenetre_trouve,"treeview2n");
		afficher_les_produits_en_rupture(treeview1);
}
...
GtkWidget *fenetre_principale;
GtkWidget *fenetre_trouve;
fenetre_principale=lookup_widget(button,"fenetre_authentification");

gtk_widget_destroy(fenetre_principale);
fenetre_trouve=lookup_widget(button,"Smart_ESPRIT");
fenetre_trouve=create_Smart_ESPRIT();
...
on_R_D_R_clicked                       (GtkButton       *button,
                                        gpointer         user_data)
{
GtkWidget *fenetre_authen;
GtkWidget *fenetre_principale;
fenetre_authen=lookup_widget(button,"authentification");

gtk_widget_destroy(fenetre_authen);
fenetre_principale=lookup_widget(button,"Smart_ESPRIT");
fenetre_principale=create_Smart_ESPRIT();
...
fenetre_principale=lookup_widget(button,"authnouha");
gtk_widget_destroy(fenetre_principale);
...
windowa=lookup_widget(button,"window_login_gas");
gtk_widget_destroy(windowa);

windowb=create_Smart_ESPRIT();
gtk_widget_show(windowb);
}
...
fenetre_principale=lookup_widget(button,"fenetre_principale");
...
fenetre_principale=lookup_widget(button,"fenetre_nombre");

gtk_widget_destroy(fenetre_principale);
fenetre_trouve=lookup_widget(button,"Dashboard_esprit");
...
windowa=lookup_widget(button,"window_agent_gas");
gtk_widget_destroy(windowa);
...
fenetre_principale=lookup_widget(button,"meilleur_menu");
...
fenetre_principale=lookup_widget(button,"meilleur_plat");
...
fenetre_principale=lookup_widget(button,"affichage0");
gtk_widget_destroy(fenetre_principale);
